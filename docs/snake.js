...
var ASM_CONSTS = {
  105520: () => { if (document.fullscreenElement) return 1; },  
 105566: () => { return document.getElementById('canvas').width; },  
 105618: () => { return parseInt(document.getElementById('canvas').style.width); },  
 105686: () => { document.exitFullscreen(); },  
 105713: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 105786: () => { if (document.fullscreenElement) return 1; },  
 105832: () => { return document.getElementById('canvas').width; },  
 105884: () => { return screen.width; },  
 105909: () => { document.exitFullscreen(); },  
 105936: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 106069: () => { return window.innerWidth; },  
 106095: () => { return window.innerHeight; },  
 106122: () => { if (document.fullscreenElement) return 1; },  
 106168: () => { return document.getElementById('canvas').width; },  
 106220: () => { return parseInt(document.getElementById('canvas').style.width); },  
 106288: () => { if (document.fullscreenElement) return 1; },  
 106334: () => { return document.getElementById('canvas').width; },  
 106386: () => { return screen.width; },  
 106411: () => { return window.innerWidth; },  
 106437: () => { return window.innerHeight; },  
 106464: () => { if (document.fullscreenElement) return 1; },  
 106510: () => { return document.getElementById('canvas').width; },  
 106562: () => { return screen.width; },  
 106587: () => { document.exitFullscreen(); },  
 106614: () => { if (document.fullscreenElement) return 1; },  
 106660: () => { return document.getElementById('canvas').width; },  
 106712: () => { return parseInt(document.getElementById('canvas').style.width); },  
 106780: () => { document.exitFullscreen(); },  
 106807: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 106865: () => { return screen.width; },  
 106890: () => { return screen.height; },  
 106916: () => { return window.screenX; },  
 106943: () => { return window.screenY; },  
 106970: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 107023: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 107094: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 107151: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 107407: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 107478: () => { if (document.fullscreenElement) return 1; },  
 107524: () => { return window.innerWidth; },  
 107550: () => { return window.innerHeight; },  
 107577: () => { if (document.pointerLockElement) return 1; }
};
